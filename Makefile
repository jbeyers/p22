...
build-acceptance-servers: ## Build Acceptance Servers
	...
	@docker build backend -t jbeyers/p22-backend:acceptance -f backend/Dockerfile.acceptance
	@echo "Build acceptance frontend"
	@docker build frontend -t jbeyers/p22-frontend:acceptance -f frontend/Dockerfile
